...
import { Instagram, MessageCircle, Linkedin, Mail, MapPin, Clock } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <Card className="glass border-none p-8">
              <h3 className="text-2xl font-bold mb-6 text-gradient">Quick Response</h3>
              <p className="text-muted-foreground mb-6">
                I'm always excited to discuss new projects and collaborations. 
                Whether you need a compelling advertising video or professional modeling services, 
          ...
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-2xl font-bold mb-8 text-gradient">Follow My Journey</h3>
            ...
            {socialLinks.map((social, index) => (
              ...
              >
                <a href={social.href} className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center bg-background/10 ${social.color} group-hover:scale-110 transition-transform`}>
